...
<body class="text-gray-800">
            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <h1 class="text-xl font-bold text-gray-900">Análisis de Subsidios de Vivienda</h1>
                    </div>
                </div>
    ...
    <main class="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <section id="overview" class="scroll-mt-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="kpi-card">
                    ...
                    <p class="text-sm text-gray-500 mt-2">Registros únicos validados</p>
                </div>
                <div class="kpi-card">
                    <h3 class="text-gray-500 font-medium">Monto Promedio del Bono</h3>
                    <p class="text-4xl font-bold text-[#00487C] mt-2">~₡21.17M</p>
                    <p class="text-sm text-gray-500 mt-2">Cubre casi el 100% de la solución</p>
                </div>
                <div class="kpi-card">
                    <h3 class="text-gray-500 font-medium">Solución Promedio Pagada</h3>
                    <p class="text-4xl font-bold text-[#00487C] mt-2">~₡21.29M</p>
        ...
        <section id="profile" class="scroll-mt-20">
            ...
            <p class="text-lg text-gray-600 mb-8">Perfil sociodemográfico de las familias, demostrando la efectiva focalización del programa.</p>
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="kpi-card text-center">
                    <h3 class="text-gray-500 font-medium">Edad Promedio</h3>
                    <p class="text-4xl font-bold text-[#00487C] mt-2">40.6 años</p>
                </div>
                <div class="kpi-card text-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
                    <h3 class="text-xl font-semibold mb-4 text-center">Nivel Educativo por Género</h3>
                     <p class="text-center text-gray-600 mb-4 max-w-3xl mx-auto">La mayoría de beneficiarios tiene un nivel educativo de primaria o inferior, reforzando el enfoque del programa en poblaciones vulnerables.</p>
                    <div class="chart-container mx-auto">
                        <canvas id="educationGenderChart"></canvas>
                    </div>
                </div>
                <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
                    <h3 class="text-xl font-semibold mb-4 text-center">Distribución de Ingresos del Núcleo Familiar</h3>
                    <p class="text-center text-gray-600 mb-4 max-w-3xl mx-auto">El histograma muestra que la gran mayoría de las familias beneficiarias tienen ingresos mensuales muy bajos, validando la focalización del programa.</p>
                    <div class="chart-container mx-auto">
        ...
        <section id="geo" class="scroll-mt-20">
            ...
            <p class="text-lg text-gray-600 mb-8">Explore la distribución espacial de los subsidios. El mapa interactivo muestra la concentración por provincia.</p>
        ...
        <section id="financial" class="scroll-mt-20">
            <h2 class="text-3xl font-bold text-gray-900 mb-2">Análisis Financiero</h2>
            <p class="text-lg text-gray-600 mb-8">Detalles sobre el destino de la inversión y los programas de financiamiento.</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
                    ...
                    <p class="text-center text-gray-600 mb-4">Filtre por provincia y haga clic en una sección para ver detalles.</p>
                    <div class="chart-container mx-auto">
        ...
        <section id="assistant" class="scroll-mt-20">
            ...
            <p class="text-lg text-gray-600 mb-8">¿Tiene alguna pregunta sobre los datos? Pídale a nuestro asistente de IA que analice la información y le proporcione respuestas contextualizadas.</p>
            <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
                <div class="w-full mb-6">
                    <label for="policyQuestion" class="block text-sm font-medium text-gray-700">Escriba su consulta</label>
                    <textarea id="policyQuestion" class="mt-1 w-full p-2 border border-gray-300 rounded-md" rows="3" placeholder="Ej: ¿Cuál es el principal desafío en Puntarenas?"></textarea>
                    <button id="askAssistantBtn" class="mt-4 w-full bg-[#00487C] text-white px-4 py-2 rounded-lg hover:bg-[#027BCE] transition-colors font-semibold">✨ Preguntar al Asistente</button>
                </div>
                 <div class="flex justify-center items-center">
                    <button id="generateAnalysisBtn" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm font-semibold">📄 Generar Resumen Ejecutivo y Recomendaciones</button>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const data = {
                ...
                provinces: { 'Puntarenas': 1457, 'Limón': 1213, 'Alajuela': 1126, 'Cartago': 775, 'Guanacaste': 762, 'San José': 756, 'Heredia': 137 },
                cantonFlows: [
                ...
                purpose: {
                    'Todos': { 'Compra Lote y Construcción': 4080, 'Construcción Lote Propio': 1468, 'Mejoras/Ampliación': 400, 'Emergencia': 88, 'Otros': 190 },
                    'San José': { 'Compra Lote y Construcción': 500, 'Construcción Lote Propio': 150, 'Mejoras/Ampliación': 80, 'Emergencia': 10, 'Otros': 28 },
                    'Alajuela': { 'Compra Lote y Construcción': 750, 'Construcción Lote Propio': 250, 'Mejoras/Ampliación': 80, 'Emergencia': 11, 'Otros': 30 },
                    'Cartago': { 'Compra Lote y Construcción': 450, 'Construcción Lote Propio': 250, 'Mejoras/Ampliación': 50, 'Emergencia': 10, 'Otros': 20 },
                    'Heredia': { 'Compra Lote y Construcción': 90, 'Construcción Lote Propio': 30, 'Mejoras/Ampliación': 10, 'Emergencia': 2, 'Otros': 6 },
                    'Guanacaste': { 'Compra Lote y Construcción': 500, 'Construcción Lote Propio': 200, 'Mejoras/Ampliación': 40, 'Emergencia': 5, 'Otros': 15 },
                    'Puntarenas': { 'Compra Lote y Construcción': 900, 'Construcción Lote Propio': 400, 'Mejoras/Ampliación': 80, 'Emergencia': 25, 'Otros': 50 },
                    'Limón': { 'Compra Lote y Construcción': 890, 'Construcción Lote Propio': 188, 'Mejoras/Ampliación': 50, 'Emergencia': 25, 'Otros': 51 }
                },
                purposeDetails: {
                    'Compra Lote y Construcción': { avgBono: 23017370, avgSolucion: 23185632 },
                    'Construcción Lote Propio': { avgBono: 17509308, avgSolucion: 17509308 },
                    'Mejoras/Ampliación': { avgBono: 16801168, avgSolucion: 16963006 },
            ...
            const renderCharts = () => {
                ...
                const purposeChartOptionsWithClick = { ...pieChartOptions, onClick: (event, elements) => {
                    if (elements.length > 0) {
                        ...
                        if (details) {
                            ...
                            detailsContainer.innerHTML = `<strong class="text-gray-800">${label}</strong><br>Bono Promedio: <span class="font-semibold">${formatCurrency(details.avgBono)}</span><br>Solución Promedio: <span class="font-semibold">${formatCurrency(details.avgSolucion)}</span>`;
                ...
                new Chart(document.getElementById('programChart'), { type: 'bar', data: { labels: Object.keys(data.programs).sort((a,b) => data.programs[b] - data.programs[a]), datasets: [{ label: 'Número de Casos', data: Object.values(data.programs).sort((a,b) => b-a), backgroundColor: colors.primary }] }, options: {...chartOptions, plugins: { legend: { display: false } } } });
            };
...
- Propósito principal: Compra de Lote y Construcción (65.5%)
- Provincias con más casos: Puntarenas (1457), Limón (1213), Alajuela (1126)
...
`;
            ...
            const setupGeminiHandlers = () => {
                document.getElementById('generateAnalysisBtn').addEventListener('click', () => {
                    const prompt = `Actuando como un experto analista de políticas de vivienda en Costa Rica, analiza los siguientes datos clave sobre el programa de subsidios y genera un resumen ejecutivo conciso seguido de tres recomendaciones estratégicas detalladas y accionables. El tono debe ser formal y propositivo.
Datos Clave:
${getDashboardSummary()}`;
                    callGemini(prompt);
                });
                ...
                document.getElementById('askAssistantBtn').addEventListener('click', () => {
                    ...
                    const prompt = `Eres un asistente de IA experto en políticas públicas de vivienda en Costa Rica. Basado en los siguientes datos resumidos del programa de subsidios, responde la pregunta del analista de la manera más clara y contextualizada posible.
Datos del Programa:
${getDashboardSummary()}
